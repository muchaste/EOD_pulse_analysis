...
root_dir <- "P:/MV responses to hypoxia/02 Analysis Output/eod_extraction"
processed_dir <- "P:/MV responses to hypoxia/02 Analysis Output/eod_extraction/processed"
plot_dir <- "P:/MV responses to hypoxia/02 Analysis Output/eod_extraction/plots/"

setwd(root_dir)

# Analysis window and processing constants -----------------------------------
analysis_start_tod <- "09:00:00"    # time of day the analysis window starts, for every trial
analysis_duration_min <- 180        # length of the analysis window in minutes
baseline_duration_min <- 20         # length of the baseline window (from analysis start) used for normalization
roll_width_1s <- 10
roll_width_1m <- 5
roll_width_10m <- 3
